...
public final class UseWarehouse {
    ...
    public static void main(final String[] args) {
        ...
        final Product p1 = new ProductImpl("Acqua in bottiglia", 10);
        final Product p2 = new ProductImpl("Risotto in scatola", 10);
        final Product p3 = new ProductImpl("Gelato confezionato", 10);
