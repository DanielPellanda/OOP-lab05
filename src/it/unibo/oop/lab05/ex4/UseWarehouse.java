...
public final class UseWarehouse {
    ...
    public static void main(final String[] args) {
         ...
         */
    	final Product p1 = new ComparableProduct("Acqua in bottiglia", 10);
        final Product p2 = new ComparableProduct("Risotto in scatola", 10);
        final Product p3 = new ComparableProduct("Gelato confezionato", 10);
